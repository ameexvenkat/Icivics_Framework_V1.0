...
import icivics_pages.Icivics_StudentReg1;
import projectSpecific.base.ProjectSpecificMethods;

public class Icivics_StudentRegistration1_Test extends ProjectSpecificMethods {
	...
	public void setValues() {
		...
		authors = "Venkat";
		category = "Smoke";
		dataSheetName = "Icivics_Studentregistration";
	}
	...
	public void C383_Verifybreadcrumbs(String URL) throws IOException, InterruptedException {
		...
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifystudentpage(URL).verifybreadcrumbs();
	}
	...
	public void C384_Verifybreadcrumbspage(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifypagecount1();
	}
	...
	public void C385_Verifyvideolink(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifyregistrationvideolink();
	}
	...
	public void C387_verifytextfields(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).Verifyusernametextfields()
	...
	public void C388_verifyusernamepregenerated(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).usernamepregenerated();
	}
	...
	public void C389_verifyusernamepregeneratedrandomly(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).usernamegeneratedrandomly();
	}
	...
	public void C390_verifyentertextinallfields(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).entertextinusernamefield()
	...
	public void C391_verifyfieldsmarkedwithanasterisk(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).usernameAsteriks().firstnameAsteriks()
	...
	public void C392_verifyemailtooltips(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).hoveronemailfield().hoveronverifyemailfield();
	}
	...
	public void C393_verifyemailerrormsg(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).Enterinvalidfirstname().Enterinvalidlastname()
	...
	public void C394_verifyblankerrormsg(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifyerrormsgblankfieldall()
	...
	public void C396_verifyvalidregistration(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifyregistrationwithvaliddata();
	}
	...
	// C397 - Does classcode link lead to class code page
		...
		public void C397_Verifyclasscodelink(String URL) throws IOException, InterruptedException {
			...
			extent.attachReporter(reporter);
			new Icivics_StudentReg1(driver, node, prop).launchstudentURL(URL).verifyclasscodelink();
		}
}
