...
import icivics_pages.StudentReg3classcode;
import projectSpecific.base.ProjectSpecificMethods;

public class StudentRegistration3classcode_Test extends ProjectSpecificMethods {
	...
	public void C454_verifypagecount3(String URL) throws IOException, InterruptedException {
		...
		new StudentReg3classcode(driver, node, prop).launchstudentURL(URL).verifyregistrationwithvaliddata()
				.verifypagecount3();
	}
