...
import icivics_pages.StudentReg3Email;
import projectSpecific.base.ProjectSpecificMethods;

public class StudentRegistration3Email_Test extends ProjectSpecificMethods {
	...
	public void C372_verifypagecount3(String URL) throws IOException, InterruptedException {
		...
		new StudentReg3Email(driver, node, prop).launchstudentURL(URL).verifywithvaliddata().verifypagecount3();
	}
	...
	public void C373_verifycheckmsgdisplay(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new StudentReg3Email(driver, node, prop).launchstudentURL(URL).verifywithvaliddata()
