...
import icivics_pages.Icivics_HomepageHeaderPlay;
import projectSpecific.base.ProjectSpecificMethods;

public class Icivics_HomepageHeaderplay_Test extends ProjectSpecificMethods {
	...
	public void C12_Verifypageisunderlined(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_HomepageHeaderPlay(driver, node, prop).launchURL(URL)
