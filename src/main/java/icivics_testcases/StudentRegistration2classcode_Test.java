...
import icivics_pages.StudentReg2classcode;
import projectSpecific.base.ProjectSpecificMethods;

public class StudentRegistration2classcode_Test extends ProjectSpecificMethods {
	...
	public void C398_verifypagecount2(String URL) throws IOException, InterruptedException {
		...
		new StudentReg2classcode(driver, node, prop).launchstudentURL(URL).verifyregistrationwithvaliddata()
				.verifypagecount2();
	}
