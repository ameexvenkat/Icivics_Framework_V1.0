...
public class Icivics_StudentRegistration1classcode_Test extends ProjectSpecificMethods {
	...
	public void C425_verifyemailfieldsappear(String URL) throws IOException, InterruptedException {
		...
		new Icivics_StudentReg1classcode(driver, node, prop).launchstudentURL(URL).verifyemailfields();
	}
	...
	public void C430_verifyregistrationwithvaliddata(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1classcode(driver, node, prop).launchstudentURL(URL).verifyregistrationwithvaliddata();
	}
	...
	public void C431_verifyAsteriks(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1classcode(driver, node, prop).launchstudentURL(URL).verifyAsteriks();
	}
