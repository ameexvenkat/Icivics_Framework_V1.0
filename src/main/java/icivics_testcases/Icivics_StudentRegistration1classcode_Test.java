...
public class Icivics_StudentRegistration1classcode_Test extends ProjectSpecificMethods {
	...
	public void C425_verifyemailfieldsappear(String URL) throws IOException, InterruptedException {
		node = test.createNode("C425 - Do 'Email address' and 'Verify email address' fields appear if you select the 'Optional: Click here to enter your email address' button?");
		extent.attachReporter(reporter);
		new Icivics_StudentReg1classcode(driver, node, prop)
		.launchstudentURL(URL)
		.verifyOptionallink();
	}
	...
	public void C430_verifyregistrationwithvaliddata(String URL) throws IOException, InterruptedException {
		...
		.launchstudentURL(URL)
		.clickOptionallink()
		.entertextinusernamefield()
		.entertextinclasscodefield()
	...
	public void C433_verifyerrormsgverifyemailblankfield(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new Icivics_StudentReg1classcode(driver, node, prop).launchstudentURL(URL).verifyerrormsgverifyemailblankfield();
	}
	...
	// C435 -If you leave a required field blank and select Next, do you receive an
	// appropriate error message?
