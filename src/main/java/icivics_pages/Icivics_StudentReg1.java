...
public class Icivics_StudentReg1 extends ProjectSpecificMethods {
	public String gpropname = "StudentRegistration/studentregistration1";

	public Icivics_StudentReg1(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public Icivics_StudentReg1 launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}
	
	@When("Studentregistration email page is verified successfully")
	public Icivics_StudentReg1 verifystudentpage(String URL) {
		verifyUrlOfThePage(URL);
		return this;
	}
	
	@And("Verify breadcrumbs is displayed")
	public Icivics_StudentReg1 verifybreadcrumbs() throws IOException {
	...
	public Icivics_StudentReg1 verifypagecount1() throws IOException {
	...
	public Icivics_StudentReg1 verifyregistrationvideolink() throws IOException {
	...
	public Icivics_StudentReg1 Verifyusernametextfields() throws IOException {
	...
	public Icivics_StudentReg1 Verifyfirstnamenametextfields() throws IOException {
	...
	public Icivics_StudentReg1 Verifylastnametextfields() throws IOException {
	...
	public Icivics_StudentReg1 Verifyemailtextfields() throws IOException {
	...
	public Icivics_StudentReg1 Verifyemail2textfields() throws IOException {
	...
	public Icivics_StudentReg1 usernamepregenerated() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
	...
	public Icivics_StudentReg1 usernamegeneratedrandomly() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
		String username1 = username.getText();
	...
	public Icivics_StudentReg1 entertextinusernamefield() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		try{
	...
	public Icivics_StudentReg1 entertextinfirstnamefield() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
	...
	public Icivics_StudentReg1 entertextinlastnamefield() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
	...
	public Icivics_StudentReg1 entertextinemailfield() throws InterruptedException, IOException {
	...
	public Icivics_StudentReg1 entertextinverifyemailfield() throws InterruptedException, IOException {
	...
	public Icivics_StudentReg1 usernameAsteriks() throws IOException {
		WebElement usernamelabel = propElement(getPropfile(gpropname, "usernamelabel"));
	...
	public Icivics_StudentReg1 firstnameAsteriks() throws IOException {
	...
	public Icivics_StudentReg1 lastnameAsteriks() throws IOException {
	...
	public Icivics_StudentReg1 emailAsteriks() throws IOException {
		scrollToTheGivenWebElement(getPropfile(gpropname, "Emailaddresslabel"));
	...
	public Icivics_StudentReg1 verifyemailAsteriks() throws IOException {
	...
	public Icivics_StudentReg1 hoveronemailfield() throws InterruptedException, IOException {
	...
	public Icivics_StudentReg1 hoveronverifyemailfield() throws InterruptedException, IOException {
	...
	public Icivics_StudentReg1 Enterinvalidfirstname() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		if (firstname.isDisplayed()) {
			firstname.clear();
	...
	public Icivics_StudentReg1 Enterinvalidlastname() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
		if (lastname.isDisplayed()) {
			lastname.clear();
	...
	public Icivics_StudentReg1 Enterinvalidemailfield() throws InterruptedException {
		WebElement email = propElement(getPropfile(gpropname, "Emailaddress"));
		if (email.isDisplayed()) {
			email.clear();
	...
	public Icivics_StudentReg1 Enterinvalidverifyemailfield() throws InterruptedException {
		WebElement verifyemail = propElement(getPropfile(gpropname, "VerifyEmailaddress"));
		if (verifyemail.isDisplayed()) {
			verifyemail.clear();
			Thread.sleep(3000);
	...
	public Icivics_StudentReg1 clicknextbutton() {
		scrollToTheGivenWebElement(getPropfile(gpropname, "Emailaddresslabel"));
	...
	public Icivics_StudentReg1 verifyerrormsgforinvaliddatasubmit() {
	...
	public Icivics_StudentReg1 verifyerrormsgblankfieldall() throws InterruptedException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		firstname.clear();
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
		lastname.clear();
	...
	public Icivics_StudentReg1 verifyerrormsgfirstnameblankfield() throws InterruptedException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		firstname.clear();
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
		lastname.clear();
	...
	public Icivics_StudentReg1 verifyerrormsglastnameblankfield() throws InterruptedException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		firstname.clear();
	...
	public Icivics_StudentReg1 verifyerrormsgemailblankfield() throws InterruptedException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		firstname.clear();
		firstname.sendKeys(getPropfile(gpropname, "FirstName"));
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
	...
	public Icivics_StudentReg1 verifyerrormsgverifyemailblankfield() throws InterruptedException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		firstname.clear();
		firstname.sendKeys(getPropfile(gpropname, "FirstName"));
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
	...
	public Icivics_StudentReg1 verifyregistrationwithvaliddata() throws InterruptedException, IOException {
		waitTime(5000);
		WebElement username = propElement(getPropfile(gpropname, "username"));
		String username1 = username.getText();
	...
	public Icivics_StudentReg1 verifyclasscodelink() throws IOException {
