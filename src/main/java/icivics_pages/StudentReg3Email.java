...
public class StudentReg3Email extends ProjectSpecificMethods {
	...
	public StudentReg3Email(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg3Email launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}

	public StudentReg3Email verifywithvaliddata() throws IOException {
	...
	public StudentReg3Email verifypagecount3() throws IOException {
	...
	public StudentReg3Email verifycheckmsgdisplay() throws IOException {
	...
	public StudentReg3Email verifyemailheaderlabel() {
	...
	public StudentReg3Email verifyregisteredemaildisplay() throws IOException {
	...
	public StudentReg3Email verifyresendbutton() {
	...
	public StudentReg3Email verifyconfirmationemail() {
		scrollToTheGivenWebElement(getPropfile(gpropname5, "resendbutton"));
		WebElement resendbutton = propElement(getPropfile(gpropname5, "resendbutton"));
		resendbutton.click();
		waitTime(3000);
