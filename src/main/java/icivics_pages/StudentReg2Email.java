...
public class StudentReg2Email extends ProjectSpecificMethods {
	...
	public StudentReg2Email(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg2Email launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}

	@Then("Verify Breadcrumb indicator is on page 2")
	public StudentReg2Email verifypagecount2() throws IOException {
	...
	public StudentReg2Email verifywithvaliddata() throws IOException {
	...
	public StudentReg2Email clickbackbutton() throws InterruptedException, IOException {
	...
	public StudentReg2Email verifyclickingbackbutton() throws InterruptedException, IOException {
	...
	public StudentReg2Email verifyusernameisnotremembered() throws IOException {
	...
	public StudentReg2Email verifyfirstnameremembered() throws IOException {
	...
	public StudentReg2Email verifylastnameremembered() {
	...
	public StudentReg2Email verifyemailremembered() {
	...
	public StudentReg2Email verifyemailfieldremembered() {
		scrollToTheGivenWebElement(getPropfile(gpropname1, "Emailaddresslabel"));
	...
	public StudentReg2Email clickontermsofuselink() throws IOException {
		waitTime(5000);
	...
	public StudentReg2Email clickprivacypolicy() {
	...
	public StudentReg2Email verifypage2noemailsubscriptioncheckbox() {
	...
	public StudentReg2Email hoveronpwdfield() throws InterruptedException {
	...
	public StudentReg2Email VerifyPasswordstrengthmeter() {
	...
	public StudentReg2Email VerifyPasswordindicatormatch() {
	...
	public StudentReg2Email verifyblankerrormsgforpwdandcpwd() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
	...
	public StudentReg2Email verifyenterinvaliddataerror() {
	...
	public StudentReg2Email verifytermsofuseandprivacycheckbox() {
	...
	@Given("Click on next without entering any valid data and verify the error messages.")
	public StudentReg2Email verifyblankerrormsg() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
		String pwd = "gfgh^d$fthf&";
		WebElement password = propElement(getPropfile(gpropname3, "password1"));
		click(propElement(getPropfile(gpropname3, "finishbutton")));
	...
	public StudentReg2Email verifypage3loaded() throws InterruptedException, IOException {
