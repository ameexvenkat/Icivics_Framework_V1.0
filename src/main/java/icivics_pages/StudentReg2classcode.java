...
public class StudentReg2classcode extends ProjectSpecificMethods {
	...
	public StudentReg2classcode(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg2classcode launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}

	public StudentReg2classcode verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentReg2classcode verifypagecount2() throws IOException {
	...
	public StudentReg2classcode Clickbackbutton() throws InterruptedException, IOException {
	...
	public StudentReg2classcode verifyClickbackbutton() throws InterruptedException, IOException {
		WebElement backbutton = propElement(getPropfile(gpropname3, "backbutton"));
		backbutton.click();
		waitTime(3000);
		String cssvalue = "background-color";
	...
	public StudentReg2classcode verifyclasscoderemembered() throws IOException {
	...
	public StudentReg2classcode verifyusernameisnotremembered() throws IOException {
	...
	public StudentReg2classcode verifyfirstnameremembered() throws IOException {
	...
	public StudentReg2classcode verifylastnameremembered() {
	...
	public StudentReg2classcode verifyemailremembered() {
	...
	public StudentReg2classcode verifyemailfieldremembered() {
		scrollToTheGivenWebElement(getPropfile(gpropname1, "Emailaddresslabel"));
	...
	public StudentReg2classcode clickontermsofuselink() throws IOException {
		waitTime(5000);
	...
	public StudentReg2classcode clickprivacypolicy() {
	...
	public StudentReg2classcode verifypage2noemailsubscriptioncheckbox() {
	...
	public StudentReg2classcode hoveronpwdfield() throws InterruptedException {
	...
	public StudentReg2classcode VerifyPasswordstrengthmeter() {
	...
	public StudentReg2classcode VerifyPasswordindicatormatch() {
	...
	public StudentReg2classcode verifyblankerrormsgforpwdandcpwd() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
	...
	public StudentReg2classcode verifyenterinvaliddataerror() {
	...
	public StudentReg2classcode verifytermsofuseandprivacycheckbox() {
	...
	public StudentReg2classcode verifyblankerrormsg() {
		scrollToTheGivenWebElement(getPropfile(gpropname3, "finishbutton"));
		String pwd = "gfgh^d$fthf&";
		WebElement password = propElement(getPropfile(gpropname3, "password1"));
	...
	public StudentReg2classcode verifypage3loaded() throws InterruptedException, IOException {
