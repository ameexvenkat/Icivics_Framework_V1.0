...
public class StudentReg3classcode extends ProjectSpecificMethods {
	...
	public StudentReg3classcode(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg3classcode launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}

	public StudentReg3classcode verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentReg3classcode verifypagecount3() throws IOException {
	...
	public StudentReg3classcode verifyusernamegenerateddisplay() throws IOException {
	...
	public StudentReg3classcode verifyusernametextddisplay() {
	...
	public StudentReg3classcode verifyemailddisplay() throws IOException {
	...
	public StudentReg3classcode verifyemailtextddisplay() {
	...
	public StudentReg3classcode clickcontinuetomyassignmentbutton() {
