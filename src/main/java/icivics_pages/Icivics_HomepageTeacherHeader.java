...
public class Icivics_HomepageTeacherHeader extends ProjectSpecificMethods {
	...
	public Icivics_HomepageTeacherHeader resizeheader() {
		...
		propElement(getPropfile(gpropname2, "Teachbutton"));
		WebElement hamburgericon1 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
		...
		WebElement hamburgericon2 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
		...
		WebElement hamburgericon3 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
		...
		WebElement hamburgericon4 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
		...
		WebElement hamburgericon5 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
		...
		WebElement hamburgericon6 = driver.findElement(By.xpath("//button[@class='navbar-toggle mobile-hamburger']"));
