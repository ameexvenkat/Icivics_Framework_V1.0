...
public class StudentReg1Email extends ProjectSpecificMethods {
	public String gpropname = "StudentRegistration/studentregistration1Email";

	public StudentReg1Email(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg1Email launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}

	@When("Studentregistration email page is verified successfully")
	public StudentReg1Email verifystudentpage(String URL) {
		verifyUrlOfThePage(URL);
		return this;
	}

	@And("Verify breadcrumbs is displayed")
	public StudentReg1Email verifybreadcrumbs() throws IOException {
	...
	public StudentReg1Email verifypagecount1() throws IOException {
	...
	public StudentReg1Email verifyregistrationvideolink() throws IOException {
	...
	public StudentReg1Email Verifyusernametextfields() throws IOException {
	...
	public StudentReg1Email Verifyfirstnamenametextfields() throws IOException {
	...
	public StudentReg1Email Verifylastnametextfields() throws IOException {
	...
	public StudentReg1Email Verifyemailtextfields() throws IOException {
	...
	public StudentReg1Email Verifyemail2textfields() throws IOException {
	...
	public StudentReg1Email usernamepregenerated() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
	...
	public StudentReg1Email usernamegeneratedrandomly() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		waitTime(6000);
		String username1 = username.getText();
	...
	public StudentReg1Email entertextinusernamefield() throws InterruptedException, IOException {
		WebElement username = propElement(getPropfile(gpropname, "username"));
		try {
	...
	public StudentReg1Email entertextinfirstnamefield() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
	...
	public StudentReg1Email entertextinlastnamefield() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
	...
	public StudentReg1Email entertextinemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1Email entertextinverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1Email usernameAsteriks() throws IOException {
		WebElement usernamelabel = propElement(getPropfile(gpropname, "usernamelabel"));
	...
	public StudentReg1Email firstnameAsteriks() throws IOException {
	...
	public StudentReg1Email lastnameAsteriks() throws IOException {
	...
	public StudentReg1Email emailAsteriks() throws IOException {
		scrollToTheGivenWebElement(getPropfile(gpropname, "Emailaddresslabel"));
	...
	public StudentReg1Email verifyemailAsteriks() throws IOException {
	...
	public StudentReg1Email hoveronemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1Email hoveronverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1Email Enterinvalidfirstname() throws InterruptedException, IOException {
		WebElement firstname = propElement(getPropfile(gpropname, "firstname"));
		if (firstname.isDisplayed()) {
			firstname.clear();
	...
	public StudentReg1Email Enterinvalidlastname() throws InterruptedException, IOException {
		WebElement lastname = propElement(getPropfile(gpropname, "Lastname"));
		if (lastname.isDisplayed()) {
			lastname.clear();
	...
	public StudentReg1Email Enterinvalidemailfield() throws InterruptedException {
		WebElement email = propElement(getPropfile(gpropname, "Emailaddress"));
		if (email.isDisplayed()) {
			email.clear();
	...
	public StudentReg1Email Enterinvalidverifyemailfield() throws InterruptedException {
		WebElement verifyemail = propElement(getPropfile(gpropname, "VerifyEmailaddress"));
		if (verifyemail.isDisplayed()) {
			verifyemail.clear();
			waitTime(3000);
	...
	public StudentReg1Email verifyerrormsgforinvaliddatasubmit() {
	...
	public StudentReg1Email verifyerrormsgblankfieldall() throws InterruptedException {
	...
	public StudentReg1Email verifyerrormsgfirstnameblankfield() throws InterruptedException {
	...
	public StudentReg1Email verifyerrormsglastnameblankfield() throws InterruptedException {
	...
	public StudentReg1Email verifyerrormsgemailblankfield() throws InterruptedException {
	...
	public StudentReg1Email verifyerrormsgverifyemailblankfield() throws InterruptedException {
	...
	public StudentReg1Email verifyregistrationwithvaliddata() throws InterruptedException, IOException {
	...
	public StudentReg1Email verifyclasscodelink() throws IOException {
