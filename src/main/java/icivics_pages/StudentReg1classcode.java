...
public class StudentReg1classcode extends ProjectSpecificMethods {
	...
	public StudentReg1classcode(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentReg1classcode launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	...
	public StudentReg1classcode Clickonwaitihaveaclasscodelink() {
	...
	public StudentReg1classcode verifyOptionallink() {
	...
	public StudentReg1classcode hoveronemailfield() throws InterruptedException, IOException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
	...
	public StudentReg1classcode hoveronverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode usernamepregenerated() {
	...
	public StudentReg1classcode usernamegeneratedrandomly() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinusernamefield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinclasscodefield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinfirstnamefield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinlastnamefield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode entertextinverifyemailfield() throws InterruptedException, IOException {
	...
	public StudentReg1classcode usernameAsteriks() throws IOException {
	...
	public StudentReg1classcode classcodeAsteriks() throws IOException {
	...
	public StudentReg1classcode firstnameAsteriks() throws IOException {
	...
	public StudentReg1classcode lastnameAsteriks() throws IOException {
	...
	public StudentReg1classcode emailAsteriks() throws IOException {
		scrollToTheGivenWebElement(getPropfile(gpropname2, "Emailaddresslabel"));
	...
	public StudentReg1classcode verifyemailAsteriks() throws IOException {
	...
	public StudentReg1classcode verifyinvaliderrormsg() throws InterruptedException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
	...
	public StudentReg1classcode verifyerrormsgblankfieldall() throws InterruptedException {
	...
	public StudentReg1classcode verifyerrormsgclasscodeblankfield() throws InterruptedException {
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
	...
	public StudentReg1classcode verifyerrormsgfirstnameblankfield() throws InterruptedException {
	...
	public StudentReg1classcode verifyerrormsglastnameblankfield() throws InterruptedException {
	...
	public StudentReg1classcode verifyerrormsgemailblankfield() throws InterruptedException {
	...
	public StudentReg1classcode verifyerrormsgverifyemailblankfield() throws InterruptedException {
	...
	public StudentReg1classcode verifyinvaliderrormsg2() throws InterruptedException {
		WebElement link = propElement(getPropfile(gpropname2, "Link"));
		link.click();
		WebElement classcode = propElement(getPropfile(gpropname2, "classcode"));
		classcode.clear();
